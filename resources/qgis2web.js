...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:25829',
            //extent: [563772.739554, 4822155.985463, 578010.873671, 4833435.201426],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([574489.201719, 4831529.025548, 574579.903918, 4831576.959938], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Numeracion_Valdovio_3,
    colName: 'DIRECCION',
    zoom: 19,
    collapsed: true,
    map: map,
